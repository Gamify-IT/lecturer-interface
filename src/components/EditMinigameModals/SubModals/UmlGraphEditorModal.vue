<template>
  ...
  >
      ...
      <div>
        <b-form-textarea v-model="content" placeholder="Enter UML-diagram description" rows="4"/>
      </div>
  </b-modal>
</template>
...
import { BButtonGroup, BFormGroup, BFormInput, BFormRow, BFormTextarea } from "bootstrap-vue-3";
